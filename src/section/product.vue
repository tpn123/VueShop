            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card product-item">
                        <img src="/images/product/product1.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card product-item">
                        <img src="/images/product/product2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card product-item">
                        <img src="/images/product/product3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
